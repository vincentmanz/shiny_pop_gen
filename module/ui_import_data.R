    ...
    fluidRow(
      ...
      box(
        ...
        tagList(
          ...
          br(),
          downloadButton("download_csv_raw", "Download Raw Data", class = "btn btn-primary")
        )
      ),
      box(
        width = 9,
      ...
      box(
        ...
        tagList(
          ...
          br(),
          downloadButton("download_csv_transformed", "Download Transformed Data", class = "btn btn-primary")
        )
      ),
      box(
